...
public class CaiHongPiUtils {
    ...
    public static String getCaiHongPi() {
        String httpUrl = "http://api.tianapi.com/caihongpi/index?key=f8fa8134c2ae90e5a568d1591421d741";
    ...
    public static Map<String,String> getEnsentence() {
        String httpUrl = "http://api.tianapi.com/ensentence/index?key=f8fa8134c2ae90e5a568d1591421d741";
        BufferedReader reader = null;
        String result = null;
        StringBuffer sbf = new StringBuffer();
        try {
